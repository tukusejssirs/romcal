...
export const locale: Locale = {
  ...
  names: {
    ...
    annemund_of_lyon_bishop: 'Saint Ennemond (Chamond), évêque et martyr († v. 658)',
    ...
    baldomerus_of_lyon_religious: 'Saint Galmier, religieux († v. 630)',
    ...
    dedication_of_consecrated_churches:
      'Dédicace des Églises consacrées dont on ne connaît pas la date de la consécration',
    ...
    gregory_x_pope: 'Bienheureux Grégoire X, pape († 1276)',
    ...
    jean_louis_bonnard_priest: 'Saint Jean-Louis Bonnard, prêtre et martyr († 1841)',
    jean_pierre_neel_priest: 'Saint Jean-Pierre Néel, prêtre et martyr († 1862)',
    ...
    john_francis_regis_priest: 'Saint Jean-François Régis, prêtre († 1640)',
    ...
    justus_of_lyon_bishop: 'Saint Just, évêque († v. 389)',
    ...
    marcellin_champagnat_priest: 'Saint Marcellin Champagnat, prêtre († 1840)',
    ...
    maurice_of_agaunum_and_companions_martyrs: 'Saint Maurice et ses companions, martyrs († v. 287)',
    ...
    nicetius_of_lyon_bishop: 'Saint Nizier, évêque († 573)',
    ...
    our_lady_of_fourviere: 'Notre-Dame de Fourvière',
    ...
    pothinus_of_lyon_bishop_patron_the_city_of_lyon_blandina_of_lyon_virgin_and_companions_martyrs:
      'Saint Pothin, évêque, patron de la ville de Lyon, Sainte Blandine, vierge, et leurs compagnons, martyrs († 177)',
    ...
    viator_of_lyon: 'Saint Viateur († v. 389)',
