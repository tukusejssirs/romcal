...
export const locale: Locale = {
  ...
  months: {
    0: 'Ιανουάριου',  // TODO: [Wiktionary](https://en.wiktionary.org/wiki/%CE%99%CE%B1%CE%BD%CE%BF%CF%85%CE%B1%CF%81%CE%AF%CE%BF%CF%85) suggests to use `Ιανουαρίου` as Genitive. I presume we need Genitive, however, we could consider to add Nominative too. Also compare this to `Κυριακή μετά τις 6 Ιανουαρίου` which can be found int `mr_el_2006_ed3` in the Calendar (Γενικό Ρωμαϊκό εορτολόγιο Ιανουαριος) in the bottom of the page.
  ...
  names: {
    ...
    basil_the_great_and_gregory_nazianzen_bishops:
      'Αγίου Βασιλείου του Μεγάλου και Αγίου Γρηγορίου του Ναζιανζηνού, επισκόπων και διδασκάλων της Εκκλησίας',  // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Ιανουάριος, p31
    ...
    catherine_of_siena_virgin_copatroness_of_europe:
      'Αγίας Αικατερίνης της Σιένας, παρθένου και διδασκάλου της Εκκλησίας, προστάτιδας της Ευρώπης',  // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Απρίλιος, p34
    ...
    cyril_constantine_the_philosopher_monk_and_methodius_michael_of_thessaloniki_bishop:
      'Αγίων Κύριλλου, μοναχού και Μεθόδιου, επισκόπου',  // based on: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Φεβρουάριος, p32
    cyril_constantine_the_philosopher_monk_and_methodius_michael_of_thessaloniki_bishop_copatrons_of_europe:
      'Αγίων Κύριλλου, μοναχού και Μεθόδιου, επισκόπου, Προστατών της Ευρώπης',  // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Φεβρουάριος, p32
    ...
    seven_holy_founders_of_the_servite_order:
      'Επτά Αγίων Ιδρυτών του Τάγματος των Δούλων της Μακαρίας Αειπαρθένου Μαρίας',  // src: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Φεβρουάριος, p32
    ...
    timothy_of_ephesus_and_titus_the_first_bishop_of_crete_bishops:
      'Αγίου Τίτου, πρώτου επισκόπου Κρήτης και Αγίου Τιμοθέου, επισκόπου',  // based on: mr_el_2006_ed3, Γενικό Ρωμαϊκό εορτολόγιο, Ιανουάριος, p31; TODO: Where is this used? Can't we use `timothy_of_ephesus_and_titus_of_crete_bishops` there instead?
